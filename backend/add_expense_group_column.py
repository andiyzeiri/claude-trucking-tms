#!/usr/bin/env python3
"""Add expense_group column to expenses table."""
import asyncio
import os
import json
...
async def add_column():
    ...
    async with engine.begin() as conn:
        await conn.execute(text("ALTER TABLE expenses ADD COLUMN IF NOT EXISTS expense_group VARCHAR DEFAULT 'company' NOT NULL"))
        print("Added expense_group column to expenses table")
