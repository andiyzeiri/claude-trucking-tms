  ...
  const updateField = async (id: number | 'new', field: keyof EditableRatecon, value: any) => {
    ...
    if (ratecon && !ratecon.isNew) {
      const backendData: any = {
        ...
        load_number: ratecon.load_number || '',
        carrier_name: ratecon.carrier_name || '',
        date_issued: ratecon.date_issued || '',
        pickup_date: ratecon.pickup_date || '',
        delivery_date: ratecon.delivery_date || '',
        pickup_location: ratecon.pickup_location || '',
        delivery_location: ratecon.delivery_location || '',
        ...
        commodity: ratecon.commodity || '',
        weight: ratecon.weight || 0,
        pieces: ratecon.pieces || 0,
        equipment_type: ratecon.equipment_type || '',
        broker_contact: ratecon.broker_contact || '',
        broker_phone: ratecon.broker_phone || '',
        broker_email: ratecon.broker_email || '',
        payment_terms: ratecon.payment_terms || '',
        special_instructions: ratecon.special_instructions || '',
        notes: ratecon.notes || '',
        status: ratecon.status || 'pending',
        document_url: ratecon.document_url || ''
      }
