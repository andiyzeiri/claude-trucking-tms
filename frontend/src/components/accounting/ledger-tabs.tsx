// Preserved general-ledger UI. Removed from the Accounting page when it was
// restructured to Overview / Trips / Expenses / Receivables, because the GL
// is empty in production (0 accounts, 0 journal entries, 0 mappings) and every
// tab rendered zeros. Backend routes and tables are untouched - to bring this
// back, import LedgerTabs and add it to the TABS array in page.tsx.
'use client'
...
type LedgerTabId = typeof LEDGER_TABS[number]['id']

export function LedgerTabs() {
  const [tab, setTab] = useState<LedgerTabId>('accounts')
  return (
